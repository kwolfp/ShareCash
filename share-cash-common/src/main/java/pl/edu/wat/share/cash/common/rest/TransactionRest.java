...
public interface TransactionRest {
    ...
    @RequestMapping(value = "/persons/{personId}/locations", method = RequestMethod.GET)
    List<TransactionDto> getTransactionsLocationsByPersonId(@PathVariable("personId") Long personId);
